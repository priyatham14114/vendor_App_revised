		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "park",
									"targetURL": "#comappvendorapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comappvendorapp-display": {
								"semanticObject": "comappvendorapp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.app.vendorapp",
									"url": sap.ui.require.toUrl("com/app/vendorapp")
								}
							}
						}
					}
